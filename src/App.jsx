...
const STRINGS = {
  ...
  mn: {
    ...
    tbl_bank: 'Банк', tbl_product: 'Зээлийн', tbl_rate: 'Хүү',
    tbl_max_amount: 'Дээд дүн', tbl_max_term: 'Дээд хугацаа',
    tbl_best_rates: 'Банк тус бүрийн хүү', tbl_full_compare: 'Дэлгэрэнгүй харьцуулах →',
    ...
    calc_over: 'хугацаанд',
    mini_title: 'тооцоолуур', mini_sub: 'Бодит тооцоолол', mini_live: 'БОДИТ',
